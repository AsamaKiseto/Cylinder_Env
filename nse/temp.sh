...
python3 2_nse_operator_grid_rbc.py -lf baseline
...
python3 2_nse_operator_grid_rbc.py --phys_gap 40 --phys_epochs 20 -lf pe_20
...
python3 2_nse_operator_grid_rbc.py --phys_scale 0.5 -lf ps_0.5
